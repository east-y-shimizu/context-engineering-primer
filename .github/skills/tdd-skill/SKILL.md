...
**コミットメッセージ**: コミットメッセージの形式、規約、レビューについては、プロジェクトにGit/GitHub運用スキル（例: `.github/skills/git-skill`）が存在する場合はそれを参照してください。存在しない場合は、プロジェクトのコミットメッセージ規約に従ってください。
...
- **Git/GitHub運用スキル**（例: `.github/skills/git-skill`）: コミットメッセージのレビュー、コミット履歴の整理に関する詳細
